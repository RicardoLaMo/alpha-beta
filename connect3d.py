...
class Connect3D(object):
    ...
    def __init__(self, grid_size=grid_size_recommended):
        ...
        self.direction_edges['U'] = list(range(self.grid_size_squared))
        self.direction_edges['D'] = list(range(self.grid_size_squared*(self.grid_size-1), self.grid_size_squared*self.grid_size))
